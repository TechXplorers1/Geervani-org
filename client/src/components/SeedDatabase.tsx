            ...
            const data = {
                ...
                stories: {
                    "story_1": {
                        ...
                        quote: "RSF's women's empowerment program gave me the skills and confidence to start my own business. Today, I employ five women from my community.",
                    ...
                    "story_3": {
                        ...
                        quote: "Through RSF's health programs, we've been able to reach remote villages and provide essential healthcare services to those who need it most.",
